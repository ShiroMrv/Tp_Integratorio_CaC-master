...
/*valores nesesarios:
   let catValor = document.getElementById("miSeleccion").value;
   let cantidad = document.getElementById("cantidad").value;*/

// para cantidad = cantidad*200;
/*
    en el HTML:
     <select onchange="catValor()"> 
...
funtion catValor(){
   ...
   let catValor = document.getElementById("miSeleccion").value;
     swicht(catValor){
        case "Estudiante":
           descuento = Math.floor(cantidad personas * 80)/100;
            break;
        case "Trainee":
          descuento = Math.floor(cantidad personas * 50)/100;
            break;
        case "Junior":
          descuento = Math.floor(cantidad personas * 15)/100;
    }
